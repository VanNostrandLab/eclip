...
"""
Modified from https://raw.githubusercontent.com/YeoLab/eclip/master/bin/barcodecollapsepe.py
...
help_message = """
Barcode collapse (paired-end) reads in a .bam file where the first 9 nt of the read name
...
def barcode_collapse(in_bam, out_bam):
    ...
    with pysam.Samfile(in_bam, 'r') as samfile1:
        ...
        # output barcode collapsed reads
...
def main():
    description = """Paired End randomer aware duplication removal algorithm."""
    usage = """
